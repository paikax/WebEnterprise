...
namespace WebEnterprise.Areas.Authenticated.Controllers
{
    ...
    public class ContributionController : Controller
    {
        ...
        public ContributionController(ApplicationDbContext context, UserManager<IdentityUser> userManager, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View("~/Areas/Authenticated/Views/Contribution/Index.cshtml", viewModel);
        }
        ...
        public async Task<IActionResult> CoordinatorIndex()
        {
            ...
            return View("~/Areas/Authenticated/Views/Contribution/CoordinatorIndex.cshtml", contributions);
        }
        ...
        public async Task<IActionResult> SelectedIndex()
        {
            ...
            return View("~/Areas/Authenticated/Views/Contribution/SelectedIndex.cshtml",approvedContributions);
        }
        ...
        public IActionResult Create()
        {
            ...
            return View("~/Areas/Authenticated/Views/Contribution/CreateContribution.cshtml", contribution);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            return View("~/Areas/Authenticated/Views/Contribution/EditContribution.cshtml", contribution);
        }
